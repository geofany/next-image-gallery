...
export default async function Gallery({ topic = 'currated', page }: Props) {
  
  let url
  if (topic === 'currated' && page) { //browsing beyond home
    url = `https://api.pexels.com/v1/curated?page=${page}`
  } else if (topic === 'currated') { //home
    url = `https://api.pexels.com/v1/curated`
  } else if (!page) { //1st page of search result
